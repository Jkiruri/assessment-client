...
var _t = (e, r, t) =>
  r in e
    ? Xt(e, r, { enumerable: !0, configurable: !0, writable: !0, value: t })
    : (e[r] = t);
...
function jt(e) {
  function r(t, o, l) {
    return "#" + ((1 << 24) | (t << 16) | (o << 8) | l).toString(16).slice(1);
  }
  K.updateOptions({
...
if (h !== null) {
  ...
  var ae = {
    ...
    ae = new ApexCharts(document.querySelector("#crm-conversion-ratio"), ae);
  ae.render();
}
...
if (h !== null) {
  ...
  var qe = {
    ...
    ee = new ApexCharts(document.querySelector("#crm-revenue-analytics"), qe);
  ee.render();
}
function Ut(e) {
  ee.updateOptions({
...
function Qt(e) {
  vt.updateOptions({ colors: ["rgba(" + e + ", 1)", "#ededed"] });
}
let X;
function Zt(e) {
...
if (pt !== null) {
  ...
  var Vt = {
      ...
      plotOptions: {
        bar: { columnWidth: "25%", distributed: !0, borderRadius: 7 },
      },
      dataLabels: { enabled: !1 },
      legend: { show: !1 },
      yaxis: {
...
function rr(e) {
  xt.updateOptions({
    plotOptions: {
      candlestick: {
        colors: { upward: "rgb(" + e + ")", downward: "rgba(" + e + ", 0.2)" },
      },
    },
  });
}
...
if (d !== null) {
  ...
  var de = {
    ...
    de = new ApexCharts(document.querySelector("#etherium-price-graph"), de);
  de.render();
}
  ...
  var Ae = {
      ...
      legend: {
        ...
        tooltipHoverFormatter: function (e, r) {
          return (
            e + " - " + r.w.globals.series[r.seriesIndex][r.dataPointIndex]
          );
        },
    ...
    kt = new ApexCharts(document.querySelector("#subscriptionOverview"), Ae);
  kt.render();
}
function or(e) {
  kt.updateOptions({ colors: ["rgb(" + e + ")", "#23b7e5"] });
}
      ...
      plotOptions: {
        pie: {
          ...
          donut: {
            ...
            labels: {
              show: !0,
              name: { show: !0, fontSize: "20px", color: "", offsetY: -4 },
              value: {
                show: !0,
                fontSize: "18px",
                color: void 0,
...
function ar(e) {
  qt.updateOptions({ colors: ["rgb(" + e + ")", "#23b7e5"] });
}
...
function sr(e) {
  At.updateOptions({ colors: ["rgb(" + e + ")", "rgba(" + e + ", 0.3)"] });
}
typeof Swiper < "u" &&
...
if (M !== null) {
  M.innerHTML = "";
  var Le = {
      chart: { height: 236, type: "radialBar" },
      series: [60],
      colors: ["rgb(132, 90, 223)"],
      plotOptions: {
        radialBar: {
          ...
          dataLabels: {
            ...
            value: { color: "", fontSize: "30px", show: !0 },
          },
        },
      },
      stroke: { lineCap: "round" },
...
function ur(e) {
  Z.updateOptions({ colors: ["rgba(" + e + ", 0.1)"] });
}
...
function hr(e) {
  Et.updateOptions({ colors: ["rgba(" + e + ", 1)", "#23b7e5"] });
}
...
if (u !== null) {
  ...
  var E = {
      ...
      chart: { height: 330, zoom: { enabled: !1 } },
...
function yr(e) {
  Ct.updateOptions({ colors: ["rgb(" + e + ")", "#ededed"] });
}
...
function gr(e) {
  Mt.updateOptions({ colors: ["rgb(" + e + ")", "#23b7e5", "#f5b849"] });
}
...
function vr(e) {
  Dt.updateOptions({ colors: ["rgb(" + e + ")", "#ededed", "#23b7e5"] });
}
...
if (p !== null) {
  ...
  var Ie = {
    ...
    Rt = new ApexCharts(document.querySelector("#totalInvestmentsStats"), Ie);
  Rt.render();
}
function qr(e) {
  function r(t, o, l) {
...
function Ar(e) {
  ...
  Ot.updateOptions({
    plotOptions: {
      candlestick: {
        colors: {
          upward: r(e.split(",")[0], e.split(",")[1], e.split(",")[2]),
          downward: "rgb(35, 183, 229)",
        },
      },
    },
...
function Br(e) {
  Ht.updateOptions({ colors: ["rgb(" + e + ")", "#e9e9e9"] });
}
...
function Er(e) {
  $t.updateOptions({ colors: ["rgb(" + e + ")", "rgba(230, 83, 60,0.5)"] });
}
...
if (Y !== null) {
  ...
  var Ee = {
      ...
      fill: {
        type: "gradient",
        gradient: { opacityFrom: 0.5, opacityTo: 0.2, stops: [0, 60] },
      },
    },
...
Rr.forEach((e) => {
  e.addEventListener("click", () => {
    ...
    if (
      ...
      t &&
        t.querySelectorAll(":scope > ul > .slide.has-sub > a").forEach((o) => {
      ...
      r &&
        r.querySelectorAll(":scope .slide.has-sub > a").forEach((t) => {
          ...
          t.nextElementSibling &&
            ((o = t.nextElementSibling) == null ? void 0 : o.style.display) ===
              "block" &&
        ...
        case "closed":
          e.removeAttribute("data-nav-style"),
            e.getAttribute("data-toggled") === "close-menu-close"
              ? e.removeAttribute("data-toggled")
              : e.setAttribute("data-toggled", "close-menu-close");
          break;
        case "overlay":
          e.removeAttribute("data-nav-style"),
            e.getAttribute("data-toggled") === "icon-overlay-close"
              ? (e.removeAttribute("data-toggled", "icon-overlay-close"),
                y.removeEventListener("mouseenter", T),
                y.removeEventListener("mouseleave", P))
              : window.innerWidth >= 992
              ? (e.setAttribute("data-toggled", "icon-overlay-close"),
        ...
        case "icontext":
          e.removeAttribute("data-nav-style"),
            e.getAttribute("data-toggled") === "icon-text-close"
              ? (e.removeAttribute("data-toggled", "icon-text-close"),
                y.removeEventListener("click", j),
                _.removeEventListener("click", U))
      ...
      switch (e.getAttribute("data-nav-style")) {
        ...
        case "menu-hover":
          e.getAttribute("data-toggled") === "menu-hover-closed"
            ...
            : (e.setAttribute("data-toggled", "menu-hover-closed"), f());
          break;
        case "icon-click":
        ...
        case "icon-hover":
          e.getAttribute("data-toggled") === "icon-hover-closed"
            ? (e.removeAttribute("data-toggled"), D())
            : (e.setAttribute("data-toggled", "icon-hover-closed"), f());
          break;
      }
    }
    ...
    r.forEach((o) => {
      o.addEventListener("mouseenter", () => {
        t.style.setProperty("display", "block"),
          (t.textContent = o.querySelector(".side-menu__label").textContent),
          document.querySelector("html").getAttribute("data-vertical-style") ==
            "doublemenu" && o.appendChild(t);
      }),
  ...
  (e = location.pathname == "/" ? "index" : location.pathname.substring(1)),
    ...
    document.querySelectorAll(".side-menu__item").forEach((t) => {
      if (
        ...
        t.classList.add("active"), t.parentElement.classList.add("active");
        let o = t.closest("ul"),
...
R.addEventListener("click", () => {
  let e = document.querySelector(".main-menu"),
    ...
    t = Math.ceil(Number(window.getComputedStyle(e).marginLeft.split("px")[0])),
    o = Math.ceil(
  ...
  e.scrollWidth > r.offsetWidth
    ...
    document.querySelector("html").getAttribute("dir") !== "rtl"
      ...
      : (e.scrollWidth > r.offsetWidth &&
          ...
          t.classList.remove("hidden"),
          o.classList.add("hidden")),
        n == 0 ? t.classList.add("hidden") : t.classList.remove("hidden")),
  ...
  for (const [B, H] of l) {
    ...
    (w.innerHTML = B),
      ...
      w.addEventListener("click", () => {
        ...
        for (const A of n) A.classList[A === w ? "add" : "remove"]("active");
        (m = new Pickr(
          Object.assign({ el: C, theme: B, default: "#845adf" }, H)
        )),
          m.on("changestop", (A, $) => {
            ...
            S.style.setProperty(
              "--primary",
              `${Math.floor(s[0])} ${Math.floor(s[1])} ${Math.floor(s[2])}`
            ),
              S.style.setProperty(
                "--color-primary-rgb",
                `${Math.floor(s[0])} ,${Math.floor(s[1])}, ${Math.floor(s[2])}`
